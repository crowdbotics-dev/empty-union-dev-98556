"""
Django settings for empty_union_dev_98556 project.
...
ROOT_URLCONF = 'empty_union_dev_98556.urls'
...
WSGI_APPLICATION = 'empty_union_dev_98556.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_union_dev_98556 API",
    "DESCRIPTION": "API documentation for empty_union_dev_98556 App",
    "VERSION": "v1",
}
